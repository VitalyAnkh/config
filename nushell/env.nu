...
let-env PATH = ($env.PATH | split row (char esep) | prepend '/usr/lib/ccache/bin' | append '~/.nix-profile/bin' | append '~/.cargo/bin' | append '~/.local/bin' | append '~/.ghcup/bin' | append '~/.elan/toolchains/leanprover--lean4---nightly/bin' | append '/opt/clangd/bin' | append '/usr/local/bin' | append '/usr/local/opt/llvm@17/bin' | append
...
# let-env PATH = ($env.PATH | split row (char esep) | prepend '/some/path' | append '~/.cargo/bin' | append '~/.local/bin' | append '~/.ghcup/bin' | append '~/.elan/toolchains/leanprover--lean4---nightly/bin')
