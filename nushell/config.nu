...
# alias sp = set socks_proxy socks5://127.0.0.1:1080; set http_proxy http://127.0.0.1:8118; set https_proxy $http_proxy; echo "Socks5 Proxy on";
alias ec = emacsclient --create-frame --alternate-editor=""
alias tp = trash-put
alias pqd = proxychains -q ~/.config/.emacs.d/bin/doom
alias soneapi = bash -c 'source /opt/intel/oneapi/setvars.sh ; exec nu'
alias snvhpc = bash -c 'source /etc/profile.d/nvhpc.sh ; exec nu'
