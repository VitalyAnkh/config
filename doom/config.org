...
;;                                  ("\\.lagda.md\\'" . agda2-mode)))
      #+end_src
** C/C++
=clang-format-plus= could format C/C++ code only in the modified region. Only formating modified code is a function long awaited, and [[https://github.com/microsoft/vscode/pull/104994][is provided by vscode two years ago]]. Hope I will implement this for any language in the future.
#+begin_src emacs-lisp :tangle packages.el
