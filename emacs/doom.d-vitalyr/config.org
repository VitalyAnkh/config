...
- [[#coding][Coding]]
  - [[#rust][Rust]]
  - [[#latex][LaTeX]]
  - [[#other-config-to-do][Other config to do]]
...
** input method
I use fcitx5 input method and smart-input-source to make system input method work perfectly with emacs.
#+begin_src emacs-lisp
(use-package sis
  :hook
...
Disable solaire-mode, to make org-latex-preview pictures with the same background color.
#+begin_src emacs-lisp
