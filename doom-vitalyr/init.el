...
(doom! :input
       ...
       :lang
       (agda +tree-sitter +local)                       ; types of types of types of types...
       ...
       (julia +lsp +tree-sitter)                 ; Python, R, and MATLAB in a blender
       ...
       ;; (lean +lsp)                       ; proof that mathematicians need help
       ...
       (raku +lsp +tree-sitter)                      ; the artist formerly known as perl6
